...
export default function AdminMessengerScreen() {
  ...
  const [pinnedMessages, setPinnedMessages] = useState([
    ...
    },
    {
      id: 'p2',
      sender: 'Admin (Katelynn)',
      text: '📢 Remember to submit your timesheets by Sunday evening. Thank you for your dedication!',
      time: '1 day ago',
      region: 'all',
      isPinned: true
    }
  ...
  const [messages, setMessages] = useState<Message[]>([
    ...
    },
    {
      id: '4',
      sender: 'Admin (Katelynn)',
      text: 'Welcome Michael! Our Tampa team is fantastic. Jessica will reach out to you with local insights and best practices.',
      time: '8:37 PM',
      region: 'tampa',
      read: true,
      isAdmin: true,
  ...
  const [groupChats, setGroupChats] = useState<GroupChat[]>([
    {
      ...
      lastMessage: {
        text: 'I\'ll be covering for Angela tonight with the twins',
        time: '2:45 PM',
        sender: 'Michael Chen'
      },
      unreadCount: 2
    ...
    {
      id: 'group2',
      name: 'Johnson Family Coordination',
      members: [
        {
          id: 'nurse2',
          name: 'Michael Chen',
      ...
      lastMessage: {
        text: 'Baby Oliver has been having trouble with the new formula',
        time: '10:15 AM',
        sender: 'Jessica Martinez'
      },
      unreadCount: 0
    ...
    {
      id: 'group3',
      name: 'Williams Family Night Team',
      members: [
        {
          id: 'nurse1',
          name: 'Angela Davis',
      ...
      lastMessage: {
        text: 'The new sleep training method is working great!',
        time: 'Yesterday',
        sender: 'David Thompson'
      },
      unreadCount: 0
    ...
    'group1': [
      {
        id: 'g1-1',
        sender: 'Admin (Katelynn)',
        text: 'I\'ve created this group to coordinate care for the Smith twins. Angela, Michael, and Sophia will be rotating shifts.',
        time: '3 days ago',
        region: 'all',
        read: true,
        isAdmin: true
      },
      {
        ...
        sender: 'Angela Davis',
        avatar: 'https://images.pexels.com/photos/5327585/pexels-photo-5327585.jpeg?auto=compress&cs=tinysrgb&w=300',
        text: 'Thanks for setting this up! I\'ve been working with the twins for a week now and have established a good routine.',
        time: '3 days ago',
        region: 'northeast-fl',
        read: true,
        isAdmin: false
      },
      {
        ...
        sender: 'Sophia Rodriguez',
        avatar: 'https://images.pexels.com/photos/5407206/pexels-photo-5407206.jpeg?auto=compress&cs=tinysrgb&w=300',
        text: 'Looking forward to my shift tomorrow. Any specific notes I should know about?',
        time: '2 days ago',
        region: 'northeast-fl',
        read: true,
        isAdmin: false
      },
      {
        ...
        sender: 'Angela Davis',
        avatar: 'https://images.pexels.com/photos/5327585/pexels-photo-5327585.jpeg?auto=compress&cs=tinysrgb&w=300',
        text: 'Emma has been a bit fussy around 2am, but a gentle rock and white noise machine helps. Liam is sleeping through the night now.',
        time: '2 days ago',
        region: 'northeast-fl',
        read: true,
        isAdmin: false
      },
      {
        ...
        sender: 'Michael Chen',
        avatar: 'https://images.pexels.com/photos/5452201/pexels-photo-5452201.jpeg?auto=compress&cs=tinysrgb&w=300',
        text: 'I\'ll be covering for Angela tonight with the twins. Thanks for the tips!',
        time: '2:45 PM',
        region: 'tampa',
        read: false,
        isAdmin: false
    ...
    'group2': [
      {
        id: 'g2-1',
        sender: 'Admin (Katelynn)',
        text: 'This group is for coordinating care for the Johnson family. Michael and Jessica will be the primary nurses.',
        time: '1 week ago',
        region: 'all',
        read: true,
        isAdmin: true
      },
      {
        ...
        sender: 'Jessica Martinez',
        avatar: 'https://images.pexels.com/photos/6749773/pexels-photo-6749773.jpeg?auto=compress&cs=tinysrgb&w=300',
        text: 'Baby Oliver has been having trouble with the new formula. I\'ve noted it in the night log.',
        time: '10:15 AM',
        region: 'tampa',
        read: true,
        isAdmin: false
    ...
    'group3': [
      {
        id: 'g3-1',
        sender: 'Admin (Katelynn)',
        text: 'Williams family night team - please use this group to coordinate care and share updates.',
        time: '2 weeks ago',
        region: 'all',
        read: true,
        isAdmin: true
      },
      {
        ...
        sender: 'David Thompson',
        avatar: 'https://images.pexels.com/photos/5327921/pexels-photo-5327921.jpeg?auto=compress&cs=tinysrgb&w=300',
        text: 'The new sleep training method is working great! Baby Emma slept 6 hours straight last night.',
        time: 'Yesterday',
        region: 'orlando',
        read: true,
        isAdmin: false
  ...
  // List of all nurses for group creation
